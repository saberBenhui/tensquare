...
public class ProblemController {
			...
			@PathVariable("size") int size) 
	{
		...
		return new Result(true,StatusCode.OK,"热门问答查询成功",
			...
			@PathVariable("size") int size) 
	{
		...
		return new Result(true,StatusCode.OK,"等待问答查询成功",
				new PageResult<>(pageBean.getTotalElements(),pageBean.getContent())
				);
	}
	...
	{
		//调用service
		Page<Problem> pageBean =  problemService.newlist(labelid,page,size);
		return new Result(true,StatusCode.OK,"最新问答查询成功",
				new PageResult<>(pageBean.getTotalElements(),pageBean.getContent())
				);
	}
